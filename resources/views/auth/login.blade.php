...
<div class="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-12">
    <div class="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-sm">
        <div class="bg-royal px-8 py-6 text-white">
            <div class="flex items-center gap-3">
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand font-bold text-white">EL</div>
                <div>
        ...
        <div class="px-8 py-7">
            ...
            <form action="{{ route('dashboard') }}" method="GET" class="mt-6 space-y-4">
                ...
                <button type="submit"
                        class="w-full rounded-xl bg-brand px-4 py-2.5 text-sm font-bold text-white transition hover:bg-brand-dark active:translate-y-px">
                    Masuk
                </button>
            </form>
